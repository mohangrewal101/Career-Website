...
export default function AboutMe() {
  return (
    <section className="bg-white py-12 px-4 sm:px-6 lg:px-8 text-gray-900">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10">
        {/* Text Section */}
        ...
        <div className="w-full lg:w-1/3 flex justify-center">
          <div className="w-64 h-64 sm:w-80 sm:h-80 relative rounded-xl shadow-md overflow-hidden">
            <Image
